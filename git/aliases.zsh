...
alias gcoo='git chekout --ours'
alias gcot='git chekout --theirs'
alias gcom='git checkout $(git rev-parse origin/master)'
alias gcoum='git checkout $(git rev-parse upstream/master)'
alias gb='git branch'
...
alias ga='git add'
# alias gh='git hist' # collides with GitHub's `cli`!
